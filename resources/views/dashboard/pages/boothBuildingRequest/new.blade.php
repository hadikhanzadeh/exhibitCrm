        ...
        <div class="wbs-form-content main-content m-0 col-12">
            <header>
                ...
                <a class="btn btn-outline-primary"
                   href="{{ route('dashboard.boothGroupIndex',['exhibit_id' => $item->exhibition_id]) }}">{{ __('back') }}</a>
            </header>
            ...
            @elseif(Session::has('error'))
                ...
                @endphp
            @endif
            <form method="post" action="{{ route('dashboard.updateBoothBuilding', $item->id) }}">
                @csrf
                <div class="row mb-3">
                ...
                <div class="row mt-5 justify-content-between">
                    <div class="col-2">
                        <a href="{{ route('dashboard.destroyBoothBuilding', $item->id) }}"
